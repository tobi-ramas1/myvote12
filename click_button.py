...
mobile_user_agent = "Mozilla/5.0 (Linux; Android 13; Pixel 6a) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/101.0.0.0 Mobile Safari/537.36"
...
try:
    ...
    driver.add_cookie({'name': 'PHPSESSID', 'value': '46c65dba9557bee3305344fc6494b1fb'})
    time.sleep(2)
    # to refresh the page
    driver.refresh()
